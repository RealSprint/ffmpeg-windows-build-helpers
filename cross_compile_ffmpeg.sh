...
build_nv_headers() {
  ...
  elif [[ $ffmpeg_git_checkout_version == *"n6.1"* ]]; then
	# nv_headers for n6.1
	do_git_checkout https://github.com/FFmpeg/nv-codec-headers.git nv-codec-headers_git n12.1.14.0
  else
...
build_libsrt() {
  ...
  download_and_unpack_file https://github.com/Haivision/srt/archive/v1.5.4.tar.gz srt-1.4.1
  cd srt-1.4.1
    if [[ $compiler_flavors != "native" ]]; then
